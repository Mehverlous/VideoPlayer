...
static void draw_function (GtkDrawingArea *area, cairo_t *cr, int width, int height, gpointer data){
  ...
  cairo_surface_t *image2 = cairo_image_surface_create_from_png("image2.png");
  cairo_surface_t *image3 = cairo_image_surface_create_from_png("image3.png");
  cairo_surface_t *image4 = cairo_image_surface_create_from_png("image4.png");
  cairo_surface_t *image5 = cairo_image_surface_create_from_png("image5.png");

  cairo_surface_t *painted_image = cairo_image_surface_create_from_png("image.png");
